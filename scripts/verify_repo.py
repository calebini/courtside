...
REQUIRED_FILES = (
    ...
    "specs/decisions/0016-deliver-role-administration.md",
    "specs/decisions/0017-deliver-unused-season-deletion.md",
    "specs/decisions/0018-deliver-player-points.md",
    "specs/decisions/0019-deliver-member-player-statistics.md",
    "specs/decisions/0020-contain-storage-and-recovery.md",
    "specs/decisions/0021-defer-statkeeper-review-restructuring.md",
    "specs/decisions/0022-deliver-statkeeper-event-ledger-foundation.md",
    "specs/decisions/0023-deliver-statkeeper-capture-session-preflight.md",
    ...
    "src/courtside/services/manage-role-assignments.ts",
    "src/courtside/services/delete-season.ts",
    "src/courtside/services/manage-player-points.ts",
    "src/courtside/services/manage-player-photo.ts",
    "src/courtside/services/password-recovery-authorization.ts",
    "src/courtside/services/record-statkeeper-event.ts",
    "src/courtside/services/activate-statkeeper-profile.ts",
    "src/courtside/services/start-statkeeper-session.ts",
    ...
    "src/courtside/core/statkeeper-profile.ts",
    "src/courtside/core/statkeeper-capture.ts",
    "src/courtside/core/statkeeper-authority.ts",
    "src/courtside/core/statkeeper-game-queue.ts",
    "src/courtside/core/statkeeper-possession.ts",
    "src/courtside/core/statkeeper-media.ts",
    "src/courtside/core/member-statistics.ts",
    ...
    "src/courtside/adapters/postgres/role-assignment-store.ts",
    "src/courtside/adapters/postgres/role-administration-dashboard-store.ts",
    "src/courtside/adapters/postgres/season-deletion-store.ts",
    "src/courtside/adapters/postgres/player-points-store.ts",
    "src/courtside/adapters/postgres/statkeeper-event-ledger-store.ts",
    "src/courtside/adapters/postgres/statkeeper-preflight-store.ts",
    "src/courtside/adapters/postgres/statkeeper-occurrence-store.ts",
    "src/courtside/adapters/postgres/statkeeper-authority.ts",
    ...
    "src/courtside/adapters/images/sharp-profile-photo-processor.ts",
    "src/courtside/adapters/next/password-recovery-cookie.ts",
    "src/courtside/adapters/supabase/player-photo-storage.ts",
    "src/app/icon.svg",
    ...
    "supabase/migrations/20260816210000_role_administration.sql",
    "supabase/migrations/20260817120000_player_points_stat_lines.sql",
    "supabase/migrations/20260824100000_storage_and_recovery_containment.sql",
    "supabase/migrations/20260830120000_statkeeper_event_ledger_foundation.sql",
    "supabase/migrations/20260831120000_statkeeper_capture_session_preflight.sql",
    ...
    "tests/unit/role-assignments.test.ts",
    "tests/unit/season-deletion.test.ts",
    "tests/unit/player-stat-line.test.ts",
    "tests/unit/statkeeper-canonical-json.test.ts",
    "tests/unit/statkeeper-event-ledger.test.ts",
    "tests/unit/record-statkeeper-event-service.test.ts",
    "tests/unit/statkeeper-profile.test.ts",
    "tests/unit/statkeeper-media.test.ts",
    "tests/unit/statkeeper-capture.test.ts",
    "tests/unit/statkeeper-game-queue.test.ts",
    "tests/unit/statkeeper-possession.test.ts",
    "tests/unit/member-statistics.test.ts",
    "tests/unit/password-recovery-authorization.test.ts",
    "tests/unit/player-photo-security.test.ts",
    "tests/unit/profile-photo-processor.test.ts",
    ...
    "tests/integration/manage-role-assignments.postgres.test.ts",
    "tests/integration/delete-season.postgres.test.ts",
    "tests/integration/manage-player-points.postgres.test.ts",
    "tests/integration/member-statistics-store.postgres.test.ts",
    "tests/integration/password-recovery-authorization.postgres.test.ts",
    "tests/integration/record-statkeeper-event.postgres.test.ts",
    "tests/integration/statkeeper-preflight.postgres.test.ts",
    "tests/integration/record-statkeeper-occurrence.postgres.test.ts",
    "tests/integration/statkeeper-authority-queue.postgres.test.ts",
    "tests/e2e/admin-finalization.spec.ts",
    "tests/e2e/account-onboarding.spec.ts",
    "tests/e2e/roster-management.spec.ts",
    "tests/e2e/role-administration.spec.ts",
    "tests/e2e/season-deletion.spec.ts",
    "supabase/seed.sql",
