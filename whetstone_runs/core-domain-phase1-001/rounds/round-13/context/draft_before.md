...
4. Historical configuration versions remain available to explain prior calculations.
...
6. Configuration cannot enable tied final Games.
7. Unknown playoff policies, ranking criteria, or lifecycle transitions are rejected rather than silently interpreted.
