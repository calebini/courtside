...
Hash: f5bb8834ade133ab750060bb5a85e50ed2ef3b80d412affb7903765026dae02a
...
- The eligible-Player row set describes statistic-recording coverage and does not assert lineup or
  Game appearance.
- A missing Player Stat Line and unknown points display as `not recorded`; known zero displays as
  `0`; known provisional and confirmed values remain distinguishable.
...
Hash: 74d14979bc9a8e33565b66d5cec43adce1a9413c61990037e8b4328c976e9a99
...
Each Player row displays exactly one points recording state:

- no Player Stat Line or unknown points displays as `not recorded`;
- known zero displays as `0`;
- known provisional points display the value with a clear `provisional` label; and
- known confirmed points display the value as confirmed.
